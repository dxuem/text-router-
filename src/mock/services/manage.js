...
const routerMenu = (option) => {
    return builder({
        'data': [{
            ...
            meta: { title: '保护区基础数据管理', icon: 'table'},
            children: [{
              path: '/baseData/SpeciesDataMana',
              // title: "物种信息管理",
              key: "species",
              // component: RouteView,
              meta: { title: '物种信息管理', icon: 'table' },
              children: [{
                  path: '/baseData/SpeciesDataMana/familyMana',
                  // title: "科类管理",
                  key: "familyMana",
                  meta: { title: '科类管理', icon: 'table'},
    ...
    Mock.mock(/\/route\/route/, 'get', routerMenu)