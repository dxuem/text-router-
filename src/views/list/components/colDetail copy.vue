      ...
      <a-spin :spinning="confirmLoading">
        ...
        >
          ...
          <div v-show="currentStep === 0">
            <a-form-model-model-item label="级别" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="grade">
            ...
            </a-form-model-model-item>
            <a-form-model-model-item label="上级类别" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="super_id">
              <a-auto-complete
                style="width:100%"
                v-show="showInput"
        ...
        <a-form-model :form="form">
          ...
          <div v-show="currentStep === 1">
            <a-form-model-item label="COL ID" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input placeholder="请输入ID" v-model="form.col_id" />
              <!-- <a-button style="width:20%" type="primary" @click="generateUUID" >生成ID</a-button> -->
            </a-form-model-item>
            <a-form-model-item label="拉丁名" :labelCol="labelCol" disabled :wrapperCol="wrapperCol">
              <a-input-search
                v-model="form.col_name"
                placeholder="请输入拉丁名"
                enter-button
                @search="onSearchName"
                v-decorator="['col_name', {rules: [{required: true,message: '不能为空!'}]}]"
              />
            ...
            <a-form-model-item label="中文名" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input
                ...
                placeholder="请输入中文名"
                v-decorator="['col_name_cn', {rules: [{required: true,message: '不能为空!' }]}]"
              />
            </a-form-model-item>
          </div>
          <!-- step2 end -->
